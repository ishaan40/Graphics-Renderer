...
# setting SOPC_SYSID_BASE_ADDRESS is 0x10001448
SOPC_SYSID_FLAG += --sidp=0x10001448
ELF_PATCH_FLAG  += --sidp 0x10001448

# The SOPC Timestamp 
# setting SOPC_TIMESTAMP is 1588609841
SOPC_SYSID_FLAG += --timestamp=1588609841
ELF_PATCH_FLAG  += --timestamp 1588609841

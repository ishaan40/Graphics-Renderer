...
module soc_mm_interconnect_0 (
		...
		output wire [6:0]  registers_0_AES_Slave_address,                  //                    registers_0_AES_Slave.address
		output wire        registers_0_AES_Slave_write,                    //                                         .write
		output wire        registers_0_AES_Slave_read,                     //                                         .read
		input  wire [31:0] registers_0_AES_Slave_readdata,                 //                                         .readdata
		output wire [31:0] registers_0_AES_Slave_writedata,                //                                         .writedata
		output wire        registers_0_AES_Slave_chipselect,               //                                         .chipselect
	...
	wire   [31:0] registers_0_aes_slave_agent_m0_readdata;                                            // registers_0_AES_Slave_translator:uav_readdata -> registers_0_AES_Slave_agent:m0_readdata
	wire          registers_0_aes_slave_agent_m0_waitrequest;                                         // registers_0_AES_Slave_translator:uav_waitrequest -> registers_0_AES_Slave_agent:m0_waitrequest
	wire          registers_0_aes_slave_agent_m0_debugaccess;                                         // registers_0_AES_Slave_agent:m0_debugaccess -> registers_0_AES_Slave_translator:uav_debugaccess
	wire   [28:0] registers_0_aes_slave_agent_m0_address;                                             // registers_0_AES_Slave_agent:m0_address -> registers_0_AES_Slave_translator:uav_address
	wire    [3:0] registers_0_aes_slave_agent_m0_byteenable;                                          // registers_0_AES_Slave_agent:m0_byteenable -> registers_0_AES_Slave_translator:uav_byteenable
	wire          registers_0_aes_slave_agent_m0_read;                                                // registers_0_AES_Slave_agent:m0_read -> registers_0_AES_Slave_translator:uav_read
	wire          registers_0_aes_slave_agent_m0_readdatavalid;                                       // registers_0_AES_Slave_translator:uav_readdatavalid -> registers_0_AES_Slave_agent:m0_readdatavalid
	wire          registers_0_aes_slave_agent_m0_lock;                                                // registers_0_AES_Slave_agent:m0_lock -> registers_0_AES_Slave_translator:uav_lock
	wire   [31:0] registers_0_aes_slave_agent_m0_writedata;                                           // registers_0_AES_Slave_agent:m0_writedata -> registers_0_AES_Slave_translator:uav_writedata
	wire          registers_0_aes_slave_agent_m0_write;                                               // registers_0_AES_Slave_agent:m0_write -> registers_0_AES_Slave_translator:uav_write
	wire    [2:0] registers_0_aes_slave_agent_m0_burstcount;                                          // registers_0_AES_Slave_agent:m0_burstcount -> registers_0_AES_Slave_translator:uav_burstcount
	wire          registers_0_aes_slave_agent_rf_source_valid;                                        // registers_0_AES_Slave_agent:rf_source_valid -> registers_0_AES_Slave_agent_rsp_fifo:in_valid
	wire  [105:0] registers_0_aes_slave_agent_rf_source_data;                                         // registers_0_AES_Slave_agent:rf_source_data -> registers_0_AES_Slave_agent_rsp_fifo:in_data
	wire          registers_0_aes_slave_agent_rf_source_ready;                                        // registers_0_AES_Slave_agent_rsp_fifo:in_ready -> registers_0_AES_Slave_agent:rf_source_ready
	wire          registers_0_aes_slave_agent_rf_source_startofpacket;                                // registers_0_AES_Slave_agent:rf_source_startofpacket -> registers_0_AES_Slave_agent_rsp_fifo:in_startofpacket
	wire          registers_0_aes_slave_agent_rf_source_endofpacket;                                  // registers_0_AES_Slave_agent:rf_source_endofpacket -> registers_0_AES_Slave_agent_rsp_fifo:in_endofpacket
	wire          registers_0_aes_slave_agent_rsp_fifo_out_valid;                                     // registers_0_AES_Slave_agent_rsp_fifo:out_valid -> registers_0_AES_Slave_agent:rf_sink_valid
	wire  [105:0] registers_0_aes_slave_agent_rsp_fifo_out_data;                                      // registers_0_AES_Slave_agent_rsp_fifo:out_data -> registers_0_AES_Slave_agent:rf_sink_data
	wire          registers_0_aes_slave_agent_rsp_fifo_out_ready;                                     // registers_0_AES_Slave_agent:rf_sink_ready -> registers_0_AES_Slave_agent_rsp_fifo:out_ready
	wire          registers_0_aes_slave_agent_rsp_fifo_out_startofpacket;                             // registers_0_AES_Slave_agent_rsp_fifo:out_startofpacket -> registers_0_AES_Slave_agent:rf_sink_startofpacket
	wire          registers_0_aes_slave_agent_rsp_fifo_out_endofpacket;                               // registers_0_AES_Slave_agent_rsp_fifo:out_endofpacket -> registers_0_AES_Slave_agent:rf_sink_endofpacket
	wire          cmd_mux_src_valid;                                                                  // cmd_mux:src_valid -> registers_0_AES_Slave_agent:cp_valid
	wire  [104:0] cmd_mux_src_data;                                                                   // cmd_mux:src_data -> registers_0_AES_Slave_agent:cp_data
	wire          cmd_mux_src_ready;                                                                  // registers_0_AES_Slave_agent:cp_ready -> cmd_mux:src_ready
	wire    [6:0] cmd_mux_src_channel;                                                                // cmd_mux:src_channel -> registers_0_AES_Slave_agent:cp_channel
	wire          cmd_mux_src_startofpacket;                                                          // cmd_mux:src_startofpacket -> registers_0_AES_Slave_agent:cp_startofpacket
	wire          cmd_mux_src_endofpacket;                                                            // cmd_mux:src_endofpacket -> registers_0_AES_Slave_agent:cp_endofpacket
	...
	wire          registers_0_aes_slave_agent_rp_valid;                                               // registers_0_AES_Slave_agent:rp_valid -> router_002:sink_valid
	wire  [104:0] registers_0_aes_slave_agent_rp_data;                                                // registers_0_AES_Slave_agent:rp_data -> router_002:sink_data
	wire          registers_0_aes_slave_agent_rp_ready;                                               // router_002:sink_ready -> registers_0_AES_Slave_agent:rp_ready
	wire          registers_0_aes_slave_agent_rp_startofpacket;                                       // registers_0_AES_Slave_agent:rp_startofpacket -> router_002:sink_startofpacket
	wire          registers_0_aes_slave_agent_rp_endofpacket;                                         // registers_0_AES_Slave_agent:rp_endofpacket -> router_002:sink_endofpacket
	...
	wire          registers_0_aes_slave_agent_rdata_fifo_src_valid;                                   // registers_0_AES_Slave_agent:rdata_fifo_src_valid -> avalon_st_adapter:in_0_valid
	wire   [33:0] registers_0_aes_slave_agent_rdata_fifo_src_data;                                    // registers_0_AES_Slave_agent:rdata_fifo_src_data -> avalon_st_adapter:in_0_data
	wire          registers_0_aes_slave_agent_rdata_fifo_src_ready;                                   // avalon_st_adapter:in_0_ready -> registers_0_AES_Slave_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_out_0_valid;                                                      // avalon_st_adapter:out_0_valid -> registers_0_AES_Slave_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_out_0_data;                                                       // avalon_st_adapter:out_0_data -> registers_0_AES_Slave_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_out_0_ready;                                                      // registers_0_AES_Slave_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire    [0:0] avalon_st_adapter_out_0_error;                                                      // avalon_st_adapter:out_0_error -> registers_0_AES_Slave_agent:rdata_fifo_sink_error
	...
	) registers_0_aes_slave_translator (
		.clk                    (clk_0_clk_clk),                                  //                      clk.clk
		.reset                  (nios2_gen2_0_reset_reset_bridge_in_reset_reset), //                    reset.reset
		.uav_address            (registers_0_aes_slave_agent_m0_address),         // avalon_universal_slave_0.address
		.uav_burstcount         (registers_0_aes_slave_agent_m0_burstcount),      //                         .burstcount
		.uav_read               (registers_0_aes_slave_agent_m0_read),            //                         .read
		.uav_write              (registers_0_aes_slave_agent_m0_write),           //                         .write
		.uav_waitrequest        (registers_0_aes_slave_agent_m0_waitrequest),     //                         .waitrequest
		.uav_readdatavalid      (registers_0_aes_slave_agent_m0_readdatavalid),   //                         .readdatavalid
		.uav_byteenable         (registers_0_aes_slave_agent_m0_byteenable),      //                         .byteenable
		.uav_readdata           (registers_0_aes_slave_agent_m0_readdata),        //                         .readdata
		.uav_writedata          (registers_0_aes_slave_agent_m0_writedata),       //                         .writedata
		.uav_lock               (registers_0_aes_slave_agent_m0_lock),            //                         .lock
		.uav_debugaccess        (registers_0_aes_slave_agent_m0_debugaccess),     //                         .debugaccess
		.av_address             (registers_0_AES_Slave_address),                  //      avalon_anti_slave_0.address
		.av_write               (registers_0_AES_Slave_write),                    //                         .write
		.av_read                (registers_0_AES_Slave_read),                     //                         .read
		.av_readdata            (registers_0_AES_Slave_readdata),                 //                         .readdata
		.av_writedata           (registers_0_AES_Slave_writedata),                //                         .writedata
		.av_chipselect          (registers_0_AES_Slave_chipselect),               //                         .chipselect
	...
	altera_merlin_slave_agent #(
		...
		.USE_WRITERESPONSE         (0),
		.ECC_ENABLE                (0)
	) registers_0_aes_slave_agent (
		.clk                     (clk_0_clk_clk),                                          //             clk.clk
		.reset                   (nios2_gen2_0_reset_reset_bridge_in_reset_reset),         //       clk_reset.reset
		.m0_address              (registers_0_aes_slave_agent_m0_address),                 //              m0.address
		.m0_burstcount           (registers_0_aes_slave_agent_m0_burstcount),              //                .burstcount
		.m0_byteenable           (registers_0_aes_slave_agent_m0_byteenable),              //                .byteenable
		.m0_debugaccess          (registers_0_aes_slave_agent_m0_debugaccess),             //                .debugaccess
		.m0_lock                 (registers_0_aes_slave_agent_m0_lock),                    //                .lock
		.m0_readdata             (registers_0_aes_slave_agent_m0_readdata),                //                .readdata
		.m0_readdatavalid        (registers_0_aes_slave_agent_m0_readdatavalid),           //                .readdatavalid
		.m0_read                 (registers_0_aes_slave_agent_m0_read),                    //                .read
		.m0_waitrequest          (registers_0_aes_slave_agent_m0_waitrequest),             //                .waitrequest
		.m0_writedata            (registers_0_aes_slave_agent_m0_writedata),               //                .writedata
		.m0_write                (registers_0_aes_slave_agent_m0_write),                   //                .write
		.rp_endofpacket          (registers_0_aes_slave_agent_rp_endofpacket),             //              rp.endofpacket
		.rp_ready                (registers_0_aes_slave_agent_rp_ready),                   //                .ready
		.rp_valid                (registers_0_aes_slave_agent_rp_valid),                   //                .valid
		.rp_data                 (registers_0_aes_slave_agent_rp_data),                    //                .data
		.rp_startofpacket        (registers_0_aes_slave_agent_rp_startofpacket),           //                .startofpacket
		...
		.rf_sink_ready           (registers_0_aes_slave_agent_rsp_fifo_out_ready),         //         rf_sink.ready
		.rf_sink_valid           (registers_0_aes_slave_agent_rsp_fifo_out_valid),         //                .valid
		.rf_sink_startofpacket   (registers_0_aes_slave_agent_rsp_fifo_out_startofpacket), //                .startofpacket
		.rf_sink_endofpacket     (registers_0_aes_slave_agent_rsp_fifo_out_endofpacket),   //                .endofpacket
		.rf_sink_data            (registers_0_aes_slave_agent_rsp_fifo_out_data),          //                .data
		.rf_source_ready         (registers_0_aes_slave_agent_rf_source_ready),            //       rf_source.ready
		.rf_source_valid         (registers_0_aes_slave_agent_rf_source_valid),            //                .valid
		.rf_source_startofpacket (registers_0_aes_slave_agent_rf_source_startofpacket),    //                .startofpacket
		.rf_source_endofpacket   (registers_0_aes_slave_agent_rf_source_endofpacket),      //                .endofpacket
		.rf_source_data          (registers_0_aes_slave_agent_rf_source_data),             //                .data
		.rdata_fifo_sink_ready   (avalon_st_adapter_out_0_ready),                          // rdata_fifo_sink.ready
		.rdata_fifo_sink_valid   (avalon_st_adapter_out_0_valid),                          //                .valid
		.rdata_fifo_sink_data    (avalon_st_adapter_out_0_data),                           //                .data
		.rdata_fifo_sink_error   (avalon_st_adapter_out_0_error),                          //                .error
		.rdata_fifo_src_ready    (registers_0_aes_slave_agent_rdata_fifo_src_ready),       //  rdata_fifo_src.ready
		.rdata_fifo_src_valid    (registers_0_aes_slave_agent_rdata_fifo_src_valid),       //                .valid
		.rdata_fifo_src_data     (registers_0_aes_slave_agent_rdata_fifo_src_data),        //                .data
	...
	) registers_0_aes_slave_agent_rsp_fifo (
		.clk               (clk_0_clk_clk),                                          //       clk.clk
		.reset             (nios2_gen2_0_reset_reset_bridge_in_reset_reset),         // clk_reset.reset
		.in_data           (registers_0_aes_slave_agent_rf_source_data),             //        in.data
		.in_valid          (registers_0_aes_slave_agent_rf_source_valid),            //          .valid
		.in_ready          (registers_0_aes_slave_agent_rf_source_ready),            //          .ready
		.in_startofpacket  (registers_0_aes_slave_agent_rf_source_startofpacket),    //          .startofpacket
		.in_endofpacket    (registers_0_aes_slave_agent_rf_source_endofpacket),      //          .endofpacket
		.out_data          (registers_0_aes_slave_agent_rsp_fifo_out_data),          //       out.data
		.out_valid         (registers_0_aes_slave_agent_rsp_fifo_out_valid),         //          .valid
		.out_ready         (registers_0_aes_slave_agent_rsp_fifo_out_ready),         //          .ready
		.out_startofpacket (registers_0_aes_slave_agent_rsp_fifo_out_startofpacket), //          .startofpacket
		.out_endofpacket   (registers_0_aes_slave_agent_rsp_fifo_out_endofpacket),   //          .endofpacket
	...
	soc_mm_interconnect_0_router_002 router_002 (
		.sink_ready         (registers_0_aes_slave_agent_rp_ready),           //      sink.ready
		.sink_valid         (registers_0_aes_slave_agent_rp_valid),           //          .valid
		.sink_data          (registers_0_aes_slave_agent_rp_data),            //          .data
		.sink_startofpacket (registers_0_aes_slave_agent_rp_startofpacket),   //          .startofpacket
		.sink_endofpacket   (registers_0_aes_slave_agent_rp_endofpacket),     //          .endofpacket
		.clk                (clk_0_clk_clk),                                  //       clk.clk
		.reset              (nios2_gen2_0_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	soc_mm_interconnect_0_avalon_st_adapter #(
		...
		.in_0_data      (registers_0_aes_slave_agent_rdata_fifo_src_data),  //     in_0.data
		.in_0_valid     (registers_0_aes_slave_agent_rdata_fifo_src_valid), //         .valid
		.in_0_ready     (registers_0_aes_slave_agent_rdata_fifo_src_ready), //         .ready
